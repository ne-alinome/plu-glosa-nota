...
// Last modified 201811240103

// =============================================================

// U-ci dokumenta nu-du is u ge-developo projekti de Marcos Cruz
// (programandala.net), 2018; ex plu existe info in glosa.org; Marcel
// Springer tena qi.

// This document is a project under development by Marcos Cruz
// (programandala.net), 2018, based on the contents available in
// glosa.org, which are maintained  by Marcel Springer.

// U-ci dokumenta es Asciidoctor formati (viska asciidoctor.org)

// This document is in Asciidoctor format (see asciidoctor.org)
